        ...
        {loading ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {[1, 2, 3, 4].map((i) => (
              <div 
                key={i} 
                className="group bg-white/50 rounded-3xl overflow-hidden border border-stone-100 flex flex-col sm:flex-row h-[280px] animate-pulse"
              >
                <div className="sm:w-2/5 bg-stone-200" />
